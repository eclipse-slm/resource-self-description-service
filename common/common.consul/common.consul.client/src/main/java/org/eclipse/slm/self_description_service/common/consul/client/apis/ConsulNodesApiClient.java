package org.eclipse.slm.self_description_service.common.consul.client.apis;
...
public class ConsulNodesApiClient extends AbstractConsulApiClient {
    ...
    public Node getNodeByName(ConsulCredential consulCredential, String nodeName) throws ConsulLoginFailedException {
        ...
        org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses taggedAddresses = new org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses();
