package org.eclipse.slm.self_description_service.common.consul.client.utils;
...
public class ConsulObjectMapper {
    ...
    static {
        ...
        var taggedAddressesToOptionalTaggedAddresses = new Converter<org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses, Optional<TaggedAddresses>>() {
        ...
        var optionalTaggedAddressesToOptionalTaggedAddresses = new Converter<Optional<org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses>, Optional<TaggedAddresses>>() {
        ...
        var optionalTaggedAddressesToConsulTaggedAddresses = new Converter<Optional<org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses>, TaggedAddresses>() {
        ...
        modelMapper.typeMap(org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses.class, TaggedAddresses.class)
                .setProvider(p -> map(p.getSource(), ImmutableTaggedAddresses.Builder.class).build());
        modelMapper.typeMap(org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses.class, ImmutableTaggedAddresses.Builder.class)
