package org.eclipse.slm.self_description_service.common.consul.client.tests;
...
import org.eclipse.slm.self_description_service.common.consul.client.utils.ConsulObjectMapper;
...
import org.eclipse.slm.self_description_service.common.consul.model.keyvalue.KeyValueReturnValue;
...
public class ConsulObjectMapperTest {
    ...
    public void mapHashMapToTaggedAddresses() {
        var taggedAddresses = new org.eclipse.slm.self_description_service.common.consul.model.catalog.TaggedAddresses();
    ...
    public void mapConsulBindingRuleToBindingRule() {
        ...
        var bindingRule = ConsulObjectMapper.map(consulBindingRule, org.eclipse.slm.self_description_service.common.consul.model.acl.BindingRule.class);
    ...
    public void mapBindingRuleToConsulBindingRule() {
        var bindingRule = new org.eclipse.slm.self_description_service.common.consul.model.acl.BindingRule("Description", "Auth", "Selector", "Type", "BindName");
    ...
    public void mapConsulNodeServiceToNodeService() {
        ...
        var consulNodeService = ImmutableNodeService.builder().setId("Id").setService("Service").setAddress("Address")
                ...
                .build();
        var nodeService = ConsulObjectMapper.map(consulNodeService, org.eclipse.slm.self_description_service.common.consul.model.catalog.NodeService.class);
